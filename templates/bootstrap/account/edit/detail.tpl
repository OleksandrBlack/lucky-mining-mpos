  ...
  <div class="col-lg-6">
    <div class="panel panel-info">
      <div class="panel-heading">
        <i class="fa fa-edit fa-fw"></i> Детали аккаунта
      </div>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="form-group">
              ...
              <font size="1">Спрятать от других пользователей ваше имя. Для администратора оно не будет скрыто</font>
            </div>
            <div class="form-group">
              <label>Ваш PIN</label>
              <font size="1">Ваш PIN при регистрации</font>
