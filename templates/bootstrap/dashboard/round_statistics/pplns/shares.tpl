      <table class="table borderless m-b-none text-small panel-footer">
        <thead>
          <tr>
            <th></th>
            <th><span><h5><i class="fa fa-user fa-fw"></i> <span class="dashс5">Own</span></h5></span></th>
            <th><span><h5><i class="fa fa-users fa-fw"></i> <span class="dashс6">Pool</span></h5></span></th>
          </tr>
          <tr>
            <th><h5><i class="fa fa-smile-o fa-fw"></i> <span class="dashс7">Valid</span></h5></th>
            <th>
          ...
          <tr>
            <th><h5><i class="fa fa-frown-o fa-fw"></i> <span class="dashс8">Invalid</span></h5></th>
            <th>
            <div class="progress progress-striped progress-fix">
          ...
          <tr>
            <th><h5><i class="fa fa-bolt fa-fw"></i><span class="dashс9">Efficiency</span></h5></th>
            <th>
