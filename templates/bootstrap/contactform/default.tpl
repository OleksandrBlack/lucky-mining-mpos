    ...
    <div class="col-lg-12">
      <div class="panel panel-info">
        <div class="panel-heading">
          <i class="fa fa-envelope fa-fw"></i> Написать нам
        </div>
        <div class="panel-body">
          <div class="row">
            <div class="col-lg-6">
              ...
              <div class="form-group">
                <label for="senderEmail">Ваш Email адрес</label>
              ...
              <div class="form-group">
                <label for="senderEmail">Тема обращения</label>
        ...
        <div class="panel-footer">
          <button type="submit" class="btn btn-success btn-sm">Отправить Email</button>
          <button type="reset" class="btn btn-warning btn-sm">Сбросить</button></center>
        </div>
      </div>
    </div>
  </div>
